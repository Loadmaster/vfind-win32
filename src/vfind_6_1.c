...
*
* @(#)/drt/src/cmd/vfind.c $Revision: 6.1 $ $Date: 2015-12-17 $
*
* Copyright ©1994-2015 by David R. Tribble, all rights reserved.
*/
...
#define ID_C_DATE	"2015-12-17"
#define ID_C_VERS	"6.1"
...
static const char	COPYRIGHT[] =
    "@(#)Copyright (c)1994-2015 by " ID_C_AUTH ", all rights reserved.";
...
#ifdef is_unsupported
|   "                or is \"now\", \"today\", \"yesterday\", or \"tomorrow\".",
#else
    "                or is \"now\" (the current time) or \"today\" (00:00 today).",
#endif
...
static bool parse_date(const char *arg, struct _FILETIME *ft)
{
    ...
    {
        st.wDay--;			//FIXME: DOES NOT WORK FOR START OF MONTH!
        spec = true;
    }
    else if (strcmp(arg, "tomorrow") == 0  or  strcmp(arg, "tom") == 0)
    {
        st.wDay++;			//FIXME: DOES NOT WORK FOR END OF MONTH!
        spec = true;
    }
#endif
